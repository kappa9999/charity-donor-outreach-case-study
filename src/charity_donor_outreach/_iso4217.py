"""Pinned active ISO 4217 List One codes retrieved from SIX on 2026-08-01."""

ISO_4217_ACTIVE_CODES = tuple(
    """
...
ISO_4217_ACTIVE_CODE_SET = frozenset(ISO_4217_ACTIVE_CODES)
